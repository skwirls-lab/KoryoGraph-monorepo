...
export default async function ReportsPage() {
  ...
  return (
    <>
      ...
      <p className="mt-6 text-sm text-fg-muted">Retention, trial funnel and testing reports are added with Grow (M3). Ask-in-plain-English reports arrive with Intelligence (M4).</p>
    </>
  );
}
