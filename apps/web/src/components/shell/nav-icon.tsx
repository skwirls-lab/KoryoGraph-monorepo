import {
  Award, BarChart3, BookOpen, Bus, Calendar, CheckSquare, ClipboardList, CreditCard, Home, IdCard, Inbox, ListTodo, LayoutDashboard, Megaphone,
...
const MAP: Record<IconKey, LucideIcon> = {
  ...
  "trending-up": TrendingUp, wallet: Wallet, sparkles: Sparkles, clipboard: ClipboardList, bus: Bus, "id-card": IdCard, "list-todo": ListTodo,
};
