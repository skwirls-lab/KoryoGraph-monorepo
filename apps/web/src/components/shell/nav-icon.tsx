import {
  Award, BarChart3, BookOpen, Bot, Bus, Calendar, CheckSquare, ClipboardList, CreditCard, Home, IdCard, Inbox, ListTodo, LayoutDashboard, Megaphone,
...
const MAP: Record<IconKey, LucideIcon> = {
  ...
  "trending-up": TrendingUp, wallet: Wallet, sparkles: Sparkles, clipboard: ClipboardList, bus: Bus, bot: Bot, "id-card": IdCard, "list-todo": ListTodo,
};
